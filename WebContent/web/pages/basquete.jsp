...
<link href="${pageContext.request.contextPath}/resources/css/basquete.css" rel="stylesheet" type="text/css">
<!--[if lt IE 9]>
...
<body>
    ...
    <div class="gridContainer clearfix">
     	<div id="principal">
        	 <div id="div1" >
                <img src="${pageContext.request.contextPath}/resources/img/basquete.fw.png"/>
             </div>
             <div id="menu2">
