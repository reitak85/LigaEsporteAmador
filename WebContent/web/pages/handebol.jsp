...
<link href="${pageContext.request.contextPath}/resources/css/handebol.css" rel="stylesheet" type="text/css">
<!--[if lt IE 9]>
...
<body>
    ...
    <div class="gridContainer clearfix">
     	<div id="principal">
        	 <div id="div1" >
                <img src="${pageContext.request.contextPath}/resources/img/handebol.fw.png"/>
             </div>
             <div id="menu2">
