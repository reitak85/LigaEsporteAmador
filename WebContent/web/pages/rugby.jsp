...
<link href="${pageContext.request.contextPath}/resources/css/rugby.css" rel="stylesheet" type="text/css">
<!--[if lt IE 9]>
...
<body>
    ...
    <div class="gridContainer clearfix">
     	<div id="principal">
        	 <div id="div1" >
                <img src="${pageContext.request.contextPath}/resources/img/rugby.fw.png"/>
             </div>
